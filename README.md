...
🔹 19 - Obter IP Público do Oracle na Azure
...
🔹 20 - Criar Container da API .NET na Azure (Injetando a porta 1521 e liberando o Swagger)
...
🔹 21 - Testar API e Acessar o Swagger na Nuvem
...
1. Teste de Saúde (Terminal):
curl http://API_IP:8080/health

2. Interface do Swagger (Navegador):
